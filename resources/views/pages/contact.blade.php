...
@section('pageImage'){{ asset('Theme/Clean_Blog/img/contact-bg.jpg') }} @endsection
...
@section('content')
    ...
    <div class="col-lg-8 col-md-10 mx-auto">
      ...
      <form action="{{ route('sendMessage') }}" method="post" name="sendMessage" id="contactForm" novalidate>
        @csrf
